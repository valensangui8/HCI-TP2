<template>
  <div class="dashboard-page d-flex flex-column bg-background text-text">
    <Navbar />
    <div class="dashboard-content pa-5 d-flex flex-column justify-center bg-surface text-text">
      <BalanceCards />
